...
import { Game } from "./GameListModal";
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <Select.Root name="game">
              <Select.Trigger className="bg-zinc-900 py-3 px-4 rounded text-sm flex justify-between text-zinc-500 overflow-auto">
          ...
          <footer className="mt-4 flex justify-end gap-4">
            ...
            <button
              type="submit"
              className="bg-violet-500 px-5 h-12 rounded-md flex font-semibold items-center gap-3 hover:bg-violet-600"
            >
